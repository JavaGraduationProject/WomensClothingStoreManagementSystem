...
public class AlipayDemoController {
    ...
    public HashMap<String,Object> goAlipay(HttpServletRequest request, HttpServletRequest response) throws Exception {
        ...
        String out_trade_no = new String(request.getParameter("ddno").getBytes("ISO-8859-1"),"UTF-8");
        //付款金额，必填
    ...
    @RequestMapping("viewUtype")
    public String viewUtype(HttpServletRequest request) {
        return "redirect:updateutype.html";
    }
